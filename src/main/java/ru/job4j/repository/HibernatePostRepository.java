...
public class HibernatePostRepository implements PostRepository {
    ...
    public static final String FIND_POSTS_WITH_NAME = "SELECT c FROM Car As c c.text = :text";
    ...
    @Override
    public List<Post> getPostsEngine(String text) {
        Map<String, Object> map = new HashMap<>();
        map.put("text", text);
        return crudRepository.query(FIND_POSTS_WITH_NAME, Post.class, map);
    }
}
